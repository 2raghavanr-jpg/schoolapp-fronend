!(function (e) {
    ...
    e("[data-bg-src]").length > 0 &&
        ...
        e(".th-slider").each(function () {
            var t = e(this),
                ...
                c = {
                    ...
                    scrollbar: { el: t.find(".slider-scrollbar").get(0), draggable: !0 },
                },
        ...
        e(".testi-grid-dots").activateSliderThumbs({ sliderTab: !0, tabButton: ".tab-btn" });
    var i,
        r,
        l,
        c = ".ajax-contact",
        ...
        (e.fn.sectionPosition = function (t, n) {
            e(this).each(function () {
                ...
                (a = Math.floor(l.height() / 2)),
                    ...
                    "top-half" === s
                        ? (e(o).css("padding-bottom", r + a + "px"), l.css("margin-top", "-" + a + "px"))
                        : "bottom-half" === s &&
                        (e(o).css("padding-top", i + a + "px"), l.css("margin-bottom", "-" + a + "px"));
            });
        });
        ...
        (e.fn.shapeMockup = function () {
            e(this).each(function () {
                var t = e(this),
                    ...
                    s = t.data("bottom"),
                    o = t.data("left");
                t.css({ top: n, right: a, bottom: s, left: o })
                    .removeAttr("data-top")
                ...
                var s = setInterval(function () {
                    ...
                    i < 10 && (i = "0" + i),
                        ...
                        o < 0
                            ...
                            : (a(".day").html(i), a(".hour").html(r), a(".minute").html(l), a(".seconds").html(c));
                }, 1e3);
            });
        }),
    ...
    function f() {
        ...
        m[n].then((n) => {
            ...
            t.attr("id") && a.attr("id", t.attr("id")),
                ...
                t.attr("width") && (a.attr("width", t.attr("width")), t.attr("height") || a.removeAttr("height")),
                t.attr("height") && (a.attr("height", t.attr("height")), t.attr("width") || a.removeAttr("width")),
                a.insertAfter(t),
    ...
    (e.fn.lettering = function (t) {
        return t && y[t]
            ? y[t].apply(this, [].slice.call(arguments, 1))
            : "letters" !== t && t
    ...
    function b(e) {
        ...
        TweenMax.to(t, 1, {
            x: 50 * ((e.clientX - n.left) / t.offsetWidth - 0.5),
            y: 50 * ((e.clientY - n.top) / t.offsetHeight - 0.5),
            ease: Power4.easeOut,
        });
    }
    w.forEach((e) => {
    ...
    if (
                ...
                function a() {
                    n.each(function () {
                        let e = t(this),
                            ...
                            a = t(window).height(),
                            s = e.offset().top;
                        n + a > s + 340 && n < s + e.outerHeight()
                            ? e.addClass("position-sticky")
                            : e.removeClass("position-sticky");
                    });
                }
                function s(e) {
                    e.forEach((e) => {
                        e.isIntersecting
                            ? t(e.target).addClass("position-sticky")
                            : t(e.target).removeClass("position-sticky");
                    });
                }
                t(window).on("scroll", a),
                    ...
                    (function () {
                        if ("IntersectionObserver" in window) {
                            let e;
                            (e = new IntersectionObserver(s, { root: null, rootMargin: "0px", threshold: 0.1 })),
                                n.each(function () {
                                    e.observe(this);
                                });
                        }
        ...
        TweenMax.to({}, 0.016, {
            repeat: -1,
            onRepeat: function () {
                (A += (q - A) / 9), (L += (B - L) / 9), TweenMax.set(E, { css: { left: A - 12, top: L - 12 } });
            },
        }),
    ...
    if (
        (document.addEventListener("DOMContentLoaded", function () {
            ...
            !a && e && t && n
                ? ((s = ".hero-5"),
                    ...
                    gsap
                        .timeline({
                            scrollTrigger: { trigger: s, start: "top top", end: "+=1500 bottom", scrub: !0, pin: s },
                        })
                        .to(o + " .hero-thumb5", { scale: 1, duration: 10, ease: "power2.out" })
                        .to(o + " .hero-thumb5", { duration: 10 }),
                    gsap.to(i, {
                        scrollTrigger: { trigger: s, start: "top top", end: "+=1500 bottom", scrub: !0 },
                        rotationY: 180,
                        duration: 15,
                        ease: "none",
                    }))
            ...
            gsap.utils.toArray(".gsap-parallax").forEach((e) => {
                ...
                gsap.timeline({ scrollTrigger: { trigger: e, scrub: !0, pin: !1 } }).fromTo(
                    t,
        ...
        document.querySelectorAll(".text-anim").forEach((s) => {
            let o = new SplitText(s, { type: "chars, words" });
            gsap.from(o.chars, {
                duration: 2,
                delay: n,
                x: t,
        ...
        gsap.registerPlugin(ScrollTrigger),
            document.querySelectorAll(".reveal").forEach((e) => {
                let t = e.querySelector("img"),
                    n = gsap.timeline({ scrollTrigger: { trigger: e, toggleActions: "play none none none" } });
                n.set(e, { autoAlpha: 1 }),
                    n.from(e, 1, { xPercent: -100, ease: Power2.out }),
                    n.from(t, 1, { xPercent: 100, scale: 1, delay: -1, ease: Power2.out });
            });
    }
    gsap.registerPlugin(ScrollTrigger);
    ...
    function O() {
        I ||
            (window.innerWidth > 991
                ? (D ||
                    ((D = new Lenis({ lerp: 0.07 })),
                        D.on("scroll", ScrollTrigger.update),
                        gsap.ticker.add((e) => {
                            D && D.raf(1e3 * e);
                        }),
                        document.querySelectorAll(".allow-natural-scroll").forEach((e) => {
                            e.addEventListener("wheel", (e) => e.stopPropagation(), { passive: !0 }),
                                e.addEventListener("touchmove", (e) => e.stopPropagation(), { passive: !0 });
                        })),
                    D.start())
                : D && (D.stop(), (D = null)));
    }
